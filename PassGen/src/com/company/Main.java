...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			while(tryAgain)
			{
				...
				// encrypt here
				finalPassword = encryptPassword(finalPassword);
	...
	private static String encryptPassword(String finalPassword)
	{
		String rtn = "";
		encrypt = new Encryption(finalPassword);
		int[] ASCII = encrypt.encrypt();
